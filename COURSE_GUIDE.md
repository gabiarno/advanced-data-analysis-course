...
3. Follow [environment setup](SETUP.md).
...
6. Use [the diagnostic](assessments/ENTRY_DIAGNOSTIC.md) to check prerequisites before delivery, and send [the pre-course pack](participant/PRE_COURSE_PACK.md) ten days ahead.
