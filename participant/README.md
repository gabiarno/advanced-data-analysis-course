...
| [PRE_COURSE_PACK.md](PRE_COURSE_PACK.md) | Welcome letter, setup instructions, what to bring | Emailed ten days before Day 1 |
...
**To print:** open it in a browser and print to PDF or to paper. The print stylesheet adds page breaks between days, keeps the tables together, and drops the navigation. Print double-sided, A4. Allow about 40 pages.
